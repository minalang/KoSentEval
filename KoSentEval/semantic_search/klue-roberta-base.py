...
def get_embeddings(text):
    # 모델 설정
    model = AutoModel.from_pretrained('klue/roberta-base').to(device)  # or 'BM-K/KoSimCSE-roberta-multitask'
    tokenizer = AutoTokenizer.from_pretrained('klue/roberta-base')  # or 'BM-K/KoSimCSE-roberta-multitask'
    # 텍스트 처리
...
def main():
    ...
    f = open('./result/klue-roberta-base.txt', 'w')
    ...
    print(result_csv)
    f.close()
    result_csv.to_csv('./result/klue-roberta-base.csv', encoding = 'utf-8-sig')
