...
def get_embeddings(text):
    # 모델 설정
    model = AutoModel.from_pretrained('FacebookAI/xlm-roberta-base').to(device)  # or 'BM-K/KoSimCSE-roberta-multitask'
    tokenizer = AutoTokenizer.from_pretrained('FacebookAI/xlm-roberta-base')  # or 'BM-K/KoSimCSE-roberta-multitask'
    # 텍스트 처리
...
def main():
    ...
    f = open('./result/xlm-roberta-base.txt', 'w')
    ...
    print(result_csv)
    f.close()
    result_csv.to_csv('./result/xlm-roberta-base.csv', encoding = 'utf-8-sig')
